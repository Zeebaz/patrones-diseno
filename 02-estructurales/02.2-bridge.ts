...
class EmailChannel implements NotificationChannel {
  send(message: string): void {
    console.log(`%cEnviando correo electrónico: ${message}`, COLORS.green);
  }
}

class SMSChannel implements NotificationChannel {
  send(message: string): void {
    console.log(`%cEnviando SMS: ${message}`, COLORS.violet);
  }
}

class PushNotificationChannel implements NotificationChannel {
  send(message: string): void {
    console.log(`%cEnviando Push: ${message}`, COLORS.orange);
  }
}
...
class AlertNotification extends Notification {
  notify(message: string): void {
    console.log("%cNotificaciones de Alerta", COLORS.red);
...
class ReminderNotification extends Notification {
  notify(message: string): void {
    console.log("%cNotificaciones de recordatorio", COLORS.blue);
    this.channel.send(message);
  }
...
class PushNotification extends Notification {
  override notify(message: string): void {
    console.log("%cNotificaciones push", COLORS.purple);
    this.channel.send(message);
  }
