...
class SalesReport implements Report {
  ...
  generate(): void {
    console.log("%cGenerando reporte de ventas...", COLORS.purple);
  }
}
...
class InventoryReport implements Report {
  ...
  generate(): void {
    console.log("%cGenerando reporte de inventario...", COLORS.purple);
  }
}
...
abstract class ReportFactory {
  /* Protected solo puede ser alcanzado por clases hijas */
